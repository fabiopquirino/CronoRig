...
# Reescrever usando menos linhas de código
# Atribuir todas as variáveis e labels no início e destruir/ocultá-las nas funções
# Fazer uma lista com várias variáveis, ou um dicionário
# Funções: ocultar/exibir labels (de acordo com a configuração da tela)
#configurações possíveis: inicio, aguardando solução chegar, aquisição,
#intervalo, aviso vazão, pause, pré finalização (faltando 1min), finalizado
#o "c" estará relacionado ao horário real utilizando strftime, e não c+=1
#5 modos de tela: 1: início, 2: atraso vazao, 3: aquisicao, 4: intervalo, 5: intervalo final
...
#root.iconbitmap(r'C:\Users\Shell\Desktop\CronoRig\imagem.ico')
...
n = 9
## Diretórios
#CaminhoPEsperadas = r"./PEsperadas"
...
def cuspirDados():
    ...
    #diretorio_arquivo = r".\"
    #nome_completo = os.path.join(r"C:\Users\Shell\Desktop", nome_arquivo+".txt")
    #print (nome_arquivo)
